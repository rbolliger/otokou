...
abstract class BasesfGuardUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'list_max_per_page' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'list_max_per_page' => new sfValidatorString(array('max_length' => 5, 'required' => false)),
      'api_key'           => new sfValidatorString(array('max_length' => 10, 'required' => false)),
