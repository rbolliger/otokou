...
abstract class BaseGraphForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'format'           => new sfValidatorString(array('max_length' => 5)),
      'graph_name'       => new sfValidatorString(array('max_length' => 40)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'Graph', 'column' => array('sha')))
    );
