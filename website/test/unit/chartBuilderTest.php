...
$g = newChart();
$t->cmp_ok($g->generate(), '===', false, 'Even if the User has cars, nothing is generated by ChartBuilder. This task is left to childrens.');
...
$g = newChart();
$t->like($g->display(), '/Not enough data/', 'Even if the User has cars, nothing is generated by ChartBuilder. This task is left to childrens.');
