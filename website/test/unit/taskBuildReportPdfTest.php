...
try {
    ...
    $t->pass('The task fails if there are no charges related to the date/kilometers range defined as input.');
}
$report = $rq->fetchOne();
$t->ok(!$report, 'The report record is not added to the DB by calling the task');
