...
//    [7] => Maintenance
    ...
    switch ($case) {
        ...
        case 2:
            ...
            if (!$limit) {
                $y = array(
                    0 => array(290, 0.001, 0.001, 228, 0.001, 0.001, 0.001, 1014),
                );
            } else {
                if ('distance' == $range) {
                    $y = array(
                        0 => array(55, 0.001, 0.001, 139, 0.001, 0.001, 0.001, 837),
                    );
                } else {
                    $y = array(
                        0 => array(30, 0.001, 0.001, 89, 0.001, 0.001, 0.001, 830),
                    );
                }
            }
        ...
        case 4:
            ...
            if (!$limit) {
                $y = array(
                    0 => array(30, 0.001, 0.001, 50, 0.001, 0.001, 0.001, 7),
                    1 => array(30, 0.001, 0.001, 89, 0.001, 0.001, 0.001, 830),
                    2 => array(230, 0.001, 0.001, 89, 0.001, 0.001, 0.001, 177),
                );
            } else {
                if ('distance' == $range) {
                    $y = array(
                        0 => array(25, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 3),
                        1 => array(14, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 830),
                        2 => array(50, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 65),
                    );
                } else {
                    $y = array(
                        1 => array(14, 0.001, 0.001, 89, 0.001, 0.001, 0.001, 765),
                    );
                }
            }
