...
->info('2 - Index')
    ...
    ->get('/ruf/reports')
        ...
        ->begin()
            ...
            ->checkElement('h2.report_category_title',0)
    ...
    ->get('/user_gs/reports')
        ...
        ->begin()
            ...
            ->checkElement('h1:contains("Available reports")',true)
            ->checkElement('h2.report_category_title',2)
            ->checkElement('h2.report_category_title:contains("car_gs_1")',1)
            ->checkElement('div#category_car-gs-1 table.reports_list tbody tr',2)
            ->checkElement('h2.report_category_title:contains("Custom reports")',1)
            ...
            ->checkElement('div.more_reports', false)
        ->end()
     ->logout()
     ...
     ->get('/user_reports/reports')
        ...
        ->begin()
            ...
            ->checkElement('body:contains("No reports available")',false)
            ->checkElement('h1:contains("Available reports")',true)
            ->checkElement('h2.report_category_title:contains("car_reports_1")',1)
