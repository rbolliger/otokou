...
<div class="sf_admin_pagination">
    ...
    <?php if ($pager->getPage() > 1) : ?>
        <a href="<?php echo url_for('@charge') ?>?page=<?php echo $pager->getPreviousPage() ?>">
            &lt;&lt; Previous 
        </a>  
    ...
    <?php if ($pager->getPage() > 1 + floor($nb_links / 2)) : ?>
        <a href="<?php echo url_for('@charge') ?>?page=1">
            1 
        </a> 
    <?php endif; ?>
    ...
    <?php foreach ($pager->getLinks($nb_links) as $page): ?>
        ...
        <?php else: ?>
            <a href="<?php echo url_for('@charge') ?>?page=<?php echo $page ?>"><?php echo $page ?></a>
        <?php endif; ?>
    ...
    <?php if ($pager->getPage() < $pager->getLastPage() - floor($nb_links / 2)) : ?>
        <a href="<?php echo url_for('@charge') ?>?page=<?php echo $pager->getLastPage() ?>">
    ...
    <?php if ($pager->getPage() < $pager->getLastPage()) : ?>
        <span class="separator">|</span>
        <a href="<?php echo url_for('@charge') ?>?page=<?php echo $pager->getNextPage() ?>">
            Next &gt;&gt;
        </a>
    <?php endif; ?>
